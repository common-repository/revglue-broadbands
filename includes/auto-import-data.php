...

{
	...
	$jsonData = json_decode( wp_remote_retrieve_body( wp_remote_get( RGSTORE__API_URL . "api/stores/json/".$project_detail[0]->subcription_id ) ), true); 
	...
	$jsonDataCategories = json_decode( wp_remote_retrieve_body( wp_remote_get( RGSTORE__API_URL . "api/stores_categories/json/".$project_detail[0]->subcription_id ) ), true); 
...

{
	...
	$jsonDataBanners = json_decode( wp_remote_retrieve_body( wp_remote_get( RGSTORE__API_URL . "api/banners/json/".$project_detail[0]->subcription_id ) ), true); 
