...

{
	...
	{ 
		...
		$qry_response .= "<p><b>Your Broadband subscription banners is ". $project_detail[0]->status. ".&nbsp; </b><img  class='tick-icon' src=".RGSTORE__PLUGIN_URL. '/admin/images/tick.png'." /> </p>";
	...
	?><div class="rg-admin-container">
		...
		<div id="store_loader" align="center" style="display:none"><img src="<?php echo RGSTORE__PLUGIN_URL; ?>/admin/images/loading.gif" /></div>

		<div class="panel-white">

			<h4>Setup Auto Import</h4>

			<p>If you wish to setup auto import of RevGlue Broadbands Data then go to your server panel and setup CRON JOB. Your server may ask you path for the file to setup. The file path for auto data update is provided below. You can also setup daily times for the auto import.</p> 
