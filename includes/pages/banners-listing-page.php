...

{
	...
	$uploaddir = $base_dir.'/revglue/broadband/banners/';
		...
		<table class="form-table">
			...
			<tr id="rg_stores_banner_image_url" <?php echo ( empty ( $image_url ) ? 'style="display:none;"' : '' ); ?>>
				...
				<td>
					...
					<input type="text" readonly name="" class="regular-text revglue-input lg-input" id="rg_size" value="<?php echo $rg_size; ?>">
			...
			<tr id="rg_stores_banner_title" <?php echo ( empty ( $image_url ) ? 'style="display:none;"' : '' ); ?>>
				...
				<td>
					...
					<input type="text" readonly name="banner_title" class="regular-text revglue-input lg-input" id="rg_size" value="<?php echo $title; ?>">
